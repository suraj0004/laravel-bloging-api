...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\phpE95C.tmp" 
```
...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\phpE96C.tmp" 
```
...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\phpE97D.tmp" 
```
