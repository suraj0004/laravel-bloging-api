...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\php6E1.tmp" 
```
...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\php702.tmp" 
```
...
curl -X POST \
    ...
    -F "profile_photo=@C:\Users\Windows\AppData\Local\Temp\php703.tmp" 
```
